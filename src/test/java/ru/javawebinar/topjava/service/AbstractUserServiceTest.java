...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    @Test
    void changeEnabledStatusToFalse() {
        User changedUser = service.changeStatus(USER_ID);
        USER_MATCHER.assertMatch(changedUser, disabledUser);
        service.changeStatus(USER_ID);
    }
}