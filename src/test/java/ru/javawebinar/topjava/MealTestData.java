...
public class MealTestData {
    ...
    public static final Meal breakfast20221020User = new Meal(START_SEQ + 4, LocalDateTime.of(2022, Month.OCTOBER, 20, 8, 30, 0, 0), "Завтрак", 650);
    ...
    public static final Meal dinner20221020Admin = new Meal(START_SEQ + 7, LocalDateTime.of(2022, Month.OCTOBER, 20, 19, 30, 0, 0), "Ужин", 1000);
    ...
    public static final Meal dinner20221021User = new Meal(START_SEQ + 11, LocalDateTime.of(2022, Month.OCTOBER, 21, 18, 19, 0, 0), "Ужин", 400);
    public static final Meal breakfast20221021Admin = new Meal(START_SEQ + 12, LocalDateTime.of(2022, Month.OCTOBER, 21, 7, 12, 0, 0), "Завтрак", 450);
    ...
    public static final LocalDate START_DATE = LocalDate.of(2022, Month.OCTOBER, 21);
